...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Dec 29, 2024 at 07:23 PM
...
(1, 'arifdhali', 'admin1@gmail.com', 'Arif Dhali', '$2b$10$/doRIMYx6YFsKOdD0AB6DuKNDcBe.7vsb/r70u7KwetltdL7aissy', 'tsfds', '2024-12-29 19:49:13', 'kolkata');
...
(1, 'Arif Dhali', 'arif-a@yopmail.com', 'profile_img-pexels-realtoughcandycom-11035380.jpg', 'Free testing account', NULL, NULL, NULL, NULL, '$2b$10$HF185KhuLi7kZ5JQRUejaueyeZ7y98q8FBQjI0e1o/vBLhttRBuwe', '2024-12-18 23:09:02', 'active', '2024-12-29 17:06:05', NULL, NULL),
...
(11, 1, 3, 'Reiciendis Nam unde ', 119, 812, 'thumbnail-Le_Livre_d\'image.png', 'draft', '2024-12-25', '2024-12-25 07:32:33'),
(12, 1, 2, 'Illo reprehenderit ', 374, 7, 'thumbnail-Le_Livre_d\'image.png', 'draft', '2024-12-25', '2024-12-25 07:35:33');
...
CREATE TABLE IF NOT EXISTS `subscription` (
  ...
  `allowed_quantity` int DEFAULT NULL COMMENT 'Free-10, standard-30',
...
INSERT INTO `subscription` (`id`, `author_id`, `subscription_type`, `allowed_quantity`, `start_date`, `end_date`) VALUES
